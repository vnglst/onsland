...
const countryConfigs = {
  ...
  europa: {
    title: "Land Use in the European Union",
    isoCode: "EU",
    center: [10, 50],
    scale: 1200,
    categories: [
      { name: "Water", color: "var(--water-400)", percentage: 0.031 },
      { name: "Woodland", color: "var(--nature-300)", percentage: 0.41 },
      { name: "Wetland", color: "var(--nature-400)", percentage: 0.015 },
      { name: "Shrubland", color: "var(--nature-500)", percentage: 0.061 },
      { name: "Bare land", color: "var(--nature-600)", percentage: 0.042 },
      { name: "Urban area", color: "var(--urban-500)", percentage: 0.044 },
      { name: "Grassland", color: "var(--agriculture-500)", percentage: 0.171 },
      { name: "Cereals", color: "var(--agriculture-700)", percentage: 0.12 },
      { name: "Industrial crops", color: "var(--agriculture-800)", percentage: 0.031 },
      { name: "Fruit trees", color: "var(--agriculture-850)", percentage: 0.013 },
